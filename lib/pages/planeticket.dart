        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                icon: Icon(Icons.remove, color: Colors.blueAccent[900]),
                onPressed: () {
                  setState(() {
              ...
              IconButton(
                icon: Icon(Icons.add, color: Colors.blueAccent[900]),
                onPressed: () {
                  setState(() {
                    adultCount++;
                  });
...
class SeatItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Color seatColor =
        isBooked ? Colors.grey : Color.fromARGB(255, 25, 105, 171);
      ...
      Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('lightblue.png'), // Your image asset
            fit: BoxFit.cover,
          ),
        ),
      ),
    ...
    return Stack(children: [
      ...
      Container(
        decoration: BoxDecoration(
          ...
          color: Color.fromARGB(255, 98, 162, 215),
        ),
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text('Total Amount: \500.00KD', textAlign: TextAlign.center),
            SizedBox(height: 10),
            Text('Flight Ticket: \400.00KD', textAlign: TextAlign.center),
            SizedBox(height: 10),
            Text('Taxes: \50.00KD', textAlign: TextAlign.center),
            SizedBox(height: 10),
            Text('Insurance: \100.00KD', textAlign: TextAlign.center),
            SizedBox(height: 10),
            Text('Discount: -\20.0KD', textAlign: TextAlign.center),
            SizedBox(height: 10),
            Divider(color: Colors.grey),
            SizedBox(height: 10),
            Text('Grand Total: \540.00KD',
                textAlign: TextAlign.center,
                style: TextStyle(fontWeight: FontWeight.bold)),
          ],
        ),
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image:
                              AssetImage('lightblue.png'), // Your image asset
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
